// export function nameSplitOld(e: string) {
...
export function nameSplit(e: string) {
  if (e == 'farfetchd-galar') {
    ...
    return "Sirfetch'd";
  } else if (e.includes('-mega-x') || e.includes('-mega-y')) {
    return (
      e.split('-')[1].charAt(0).toUpperCase() +
      e.split('-')[1].slice(1) +
      ' ' +
      ...
      e.split('-')[0].slice(1) +
      ' ' +
      e.split('-')[2].charAt(0).toUpperCase() +
      e.split('-')[2].slice(1)
    );
  } else if (e.includes('-mega')) {
    return (
